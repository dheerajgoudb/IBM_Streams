// eJylkLFuwjAQhnWvgjrHdloqlI1KZUAQUTkMTJEhl_0Di2JF9aQlPX0MpFTO66T7Z93_16Q2cSVamO0GfZTBuU2h5AAI8jYJQkjIYO2RvOv_11S8nRYfy2Lej0Uh_0NqUWxokKe5jFzyUuSSH2j3medDmPjFx2Y6Pu3yaZvsR_1FYCkbTEwe5WmSZD_0S1beDCxC_1rtaXnFADY3rXI4gtUbVBVqy0LTjPO0xLbzrgBsay1icasUqTAOovn_05EhiPsAcU19P3YeQ9DOQm36sIf7UHEVmVL8tu0JZx7x0oLunL9pP9ICaPCXVgHGYFWL8OeoGoSzxwRIk_1nnDdoK_1W3dOtuHaO8Uvb4A_1wEZEIq9
...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple$, uint32_t port)
{
	...
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_age()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_title()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_gender()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_bonus()) << '\n';
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("MySink2",&initer));
    return true;
}
