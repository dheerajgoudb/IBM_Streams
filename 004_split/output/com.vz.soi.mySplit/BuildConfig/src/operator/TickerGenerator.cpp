// eJyVkMtqwzAQRZlfCV1bih368M41ZBFHNK21L1I8aUT06kim_0O_0rBlLossxiOIs59zIp2kpNKmaktt0ai2OY6YiwBl5mDauqYnmJyJ5x90Vi3NTD_1YOQRzqMUuRBRCEv9SL7z_1zUPw4yNbvutde6o7fqvLoarMl3HMbDvm0pZTL_0AwDYOThkBVG5pCZnPEvBMM437ymWCzaprMAHjz_0KU_0lV1h_1HTdzlwnrOuCXEayCHEAP9hv67ODggaCAtTgcLtzwOkUx5zMkGlZu6sJ6XFxrRWtAhWFQeOP8GemZnAd




#include "./TickerGenerator.h"
...
#define MY_BASE_OPERATOR TickerGenerator_Base
#define MY_OPERATOR TickerGenerator$OP
...
{
    SPL::BeJwrMS42K67MTcrPSTMtKMpMTk2yTCqt9C8KTs3JAQCbbArR tuple$;
...
while(!getPE().getShutdownRequested()) {
    ...
    try {
            ...
            failedRead = false;
                    ...
                    SPL::readCSV<SPL::boolean,','>(fs, tuple$.get_buyOrSell());
                    
                CHECK_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_TUPLE("tuple<rstring symbol,float32 price,boolean buyOrSell>", _tupleNumber));
                CHECK_FAIL;
		    ...
		    if (eolSep == EOF) {
                        ...
                        DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR ("\\n", SPL::printableCharacter(eolSep), _tupleNumber, "after reading the attribute buyOrSell"));
		    } 
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("TickerGenerator",&initer));
    return true;
}
