// t4i9minResulti9maxResulti9avgResulti9sumResult


#ifndef BEJWRMCM0ZM3MC0OTLS0PATITK2DMXLJ0GLO4NBFCBACLBRJK_H_
#define BEJWRMCM0ZM3MC0OTLS0PATITK2DMXLJ0GLO4NBFCBACLBRJK_H_
...
#define SELF BeJwrMcm0zM3MC0otLs0pATITK2DMxLJ0GLO4NBfCBAClbRJK
...
public:
    ...
    typedef SPL::int32 minResult_type;
    typedef SPL::int32 maxResult_type;
    typedef SPL::int32 avgResult_type;
    typedef SPL::int32 sumResult_type;

    enum { num_attributes = 4 } ;
    
    SELF() : Tuple(), minResult_(), maxResult_(), avgResult_(), sumResult_() {}
    SELF(const Self & ot) : Tuple(), minResult_(ot.minResult_), maxResult_(ot.maxResult_), avgResult_(ot.avgResult_), sumResult_(ot.sumResult_) 
      { constructPayload(ot); }
    SELF(const minResult_type & _minResult, const maxResult_type & _maxResult, const avgResult_type & _avgResult, const sumResult_type & _sumResult) : Tuple(), minResult_(_minResult), maxResult_(_maxResult), avgResult_(_avgResult), sumResult_(_sumResult) { }
    ...
    minResult_type & get_minResult() { return minResult_; }
    const minResult_type & get_minResult() const { return minResult_; }
    void set_minResult(const minResult_type & _minResult) { minResult_ = _minResult; }
    
    maxResult_type & get_maxResult() { return maxResult_; }
    const maxResult_type & get_maxResult() const { return maxResult_; }
    void set_maxResult(const maxResult_type & _maxResult) { maxResult_ = _maxResult; }
    
    avgResult_type & get_avgResult() { return avgResult_; }
    const avgResult_type & get_avgResult() const { return avgResult_; }
    void set_avgResult(const avgResult_type & _avgResult) { avgResult_ = _avgResult; }
    
    sumResult_type & get_sumResult() { return sumResult_; }
    const sumResult_type & get_sumResult() const { return sumResult_; }
    void set_sumResult(const sumResult_type & _sumResult) { sumResult_ = _sumResult; }
    ...
    {
        buf << minResult_ << maxResult_ << avgResult_ << sumResult_;
    }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<minResult_type >()(minResult_);
        s = 37 * s + std::tr1::hash<maxResult_type >()(maxResult_);
        s = 37 * s + std::tr1::hash<avgResult_type >()(avgResult_);
        s = 37 * s + std::tr1::hash<sumResult_type >()(sumResult_);
        return s;
    }
    ...
    { 
        minResult_ = ot.minResult_;
        maxResult_ = ot.maxResult_;
        avgResult_ = ot.avgResult_;
        sumResult_ = ot.sumResult_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(minResult_, ot.minResult_);
        std::swap(maxResult_, ot.maxResult_);
        std::swap(avgResult_, ot.avgResult_);
        std::swap(sumResult_, ot.sumResult_);
...
private:
    ...
    minResult_type minResult_;
    maxResult_type maxResult_;
    avgResult_type avgResult_;
    sumResult_type sumResult_;
...
#undef SELF
#endif // BEJWRMCM0ZM3MC0OTLS0PATITK2DMXLJ0GLO4NBFCBACLBRJK_H_ 
