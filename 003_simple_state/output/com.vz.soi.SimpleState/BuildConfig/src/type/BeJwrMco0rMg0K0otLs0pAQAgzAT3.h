...
#ifndef BEJWRMCO0RMG0K0OTLS0PAQAGZAT3_H_
#define BEJWRMCO0RMG0K0OTLS0PAQAGZAT3_H_
...
#define SELF BeJwrMco0rMg0K0otLs0pAQAgzAT3
...
public:
    ...
    typedef SPL::int32 x_type;
    typedef SPL::int32 result_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), x_(), result_() {}
    SELF(const Self & ot) : Tuple(), x_(ot.x_), result_(ot.result_) 
      { constructPayload(ot); }
    SELF(const x_type & _x, const result_type & _result) : Tuple(), x_(_x), result_(_result) { }
    ...
    x_type & get_x() { return x_; }
    const x_type & get_x() const { return x_; }
    void set_x(const x_type & _x) { x_ = _x; }
...
#undef SELF
#endif // BEJWRMCO0RMG0K0OTLS0PAQAGZAT3_H_ 
